...
<nav class="navbar navbar-fixed-top navbar-inverse">
  ...
  <div class="container">
    <div class="col-md-12">
      <form class="form-horizontal" method="post" action="new_reg1.php" >
        <fieldset>
	 ...
	 &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp	
          ...
          <div class="form-group">
            <label class="col-md-4 control-label" for="subject">Subject Name</label>
            <div class="col-md-4">
              <input id="subject" name="subject" type="text" placeholder="Subject Name" value="<?php echo isset($row['subject'])?$row['subject']:""; ?>" class="form-control input-md">
